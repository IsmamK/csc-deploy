    ...
    <div className='w-[350px]'>
      ...
      <ul className='flex flex-col gap-8 text-xs md:text-sm mb-3'>
        ...
        <li>
          ...
          >
            <FaStore className='mr-2' /> Affiliations
          </NavLink>
        </li>

        <li>
          <NavLink
            to="b2b" // Update this to your stores route
            className={({ isActive }) =>
              `flex items-center rounded-lg font-bold p-2 ${isActive ? 'bg-blue-400 text-white' : 'hover:bg-blue-400 hover:text-white'}`
            }
          >
            <FaStore className='mr-2' /> B2B
          </NavLink>
        </li>

        <li>
          <NavLink
            to="courses" // Update this to your stores route
            className={({ isActive }) =>
              `flex items-center rounded-lg font-bold p-2 ${isActive ? 'bg-blue-400 text-white' : 'hover:bg-blue-400 hover:text-white'}`
            }
          >
            <FaStore className='mr-2' /> Courses
          </NavLink>
        </li>
